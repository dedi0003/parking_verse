...
![](https://media1.tenor.com/images/8276ab228d335a8a4742a60b16fbc724/tenor.gif)
...
```{r value-box5}
valueBox("$1,263,684", 
         caption = "Fines paid in Lonsdale Street", 
         icon= "fas fa-receipt", 
         color = "#008000")
```

### Summary `r emo::ji("police")`
- These officers are quick and sneaky, even chalk tools and advances photography are used 
- Although, proportion of vehicles that violated are relatively small, a hefty sum was collected for only one street!

Column {.tabset}
------------------------------------

### 1. Estimated Durations of Overstayed Vehicles {data-height=800}
...
----------
### Conclusion
> The busiest parking street in Melbourne is Londsdale Street.  

> People tend to stick with the rules when the parking spot has meter system.  

> William Street (BetweenStreet of Lonsdale) has the highest parking duration in 1P MTR.   

> Similar patterns are observed in overstayed vehicles across the week.  

> **Takeaway: Most of the time, parking inspectors issue tickets 0 - 20 mins right after the parking violation time frame; VIOLATING PARKING TIME RESTRICTIONS IS NOT WORTH THE RISK.**
