...
=======
```{r read-in-tidy-data, cache = TRUE, eval=FALSE}
>>>>>>> refs/remotes/origin/master
...
=======
# Section 4 : There any prominent characteristics for the top 10 hardest parking street to get in Melbourne CBD?

```{r top-10, eval = FALSE}
# this is teh code to take 10 busiest parking spot from the main data
#print_table <- function(table, head){
#  table %>%
#  group_by(StreetName, BetweenStreet1, BetweenStreet2) %>%
#  summarise(CountperDay= n()/365) %>%
