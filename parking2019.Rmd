...
> Answer: The adjusted $R^2$ measures the goodness of fit in the regression model. The value here can be interpreted as the proportion of variance in log count explained by the changes in time, month, day of the week, precipitation, high and low temperature. That is, 52% of log count of pedestrians is explained by changes these variables. 
